#!/usr/bin/env python3
"""
Script para popular documentação completa do projeto EHA
Gera conteúdo detalhado para todos os documentos
"""
...
# Continuar requisitos funcionais
rf_content_append = """
...
rnf_content = """# Requisitos Não Funcionais
...
# Requisitos não funcionais
create_file(f"{docs_base}/requisitos/04-requisitos-nao-funcionais.md", rnf_content)

# Adicionar ao requisitos funcionais
with open(f"{docs_base}/requisitos/03-requisitos-funcionais.md", 'a', encoding='utf-8') as f:
    f.write(rf_content_append)

print("\n✅ Documentação atualizada com sucesso!")
print("\n📚 Próximos passos:")
print("1. Revisar documentos gerados")
print("2. Completar sprints 2-6 manualmente")
print("3. Adicionar diagramas UML")
print("4. Criar exemplos de código")
